  ...
  <div style="position: relative;">
    ...
    >
      ...
      <div
        ...
        'background-color': verifyLeftBarBackgroundColor
      }"
      >
        ...
        <div
          ...
          :style="{
            ...
            'border-color': moveBlockBackgroundColor,
            left: moveBlockLeft,
...
export default {
  ...
  data() {
    return {
      ...
      // 移动中样式
      moveBlockBackgroundColor: '#008bf6',
      leftBarBorderColor: '#F7F8FA',
      iconColor: undefined,
      ...
      verifyLeftBarBackgroundColor: '#c8e6fd'
    }
  },
  computed: {
    barArea() {
  ...
  methods: {
    ...
    start: function (e) {
      ...
      if (this.isEnd == false) {
        this.text = ''
        this.moveBlockBackgroundColor = '#008bf6'
        this.leftBarBorderColor = '#008bf6'
        this.verifyLeftBarBackgroundColor = '#c8e6fd'
        this.iconColor = '#fff'
        e.stopPropagation()
        this.status = true
      }
     ...
     */
    checkErrorHandler() {
      this.moveBlockBackgroundColor = '#F94A51'
      this.verifyLeftBarBackgroundColor = '#FFF1F0'
      this.leftBarBorderColor = '#F94A51'
      this.iconColor = '#fff'
    ...
    refresh: function () {
      ...
      this.leftBarBorderColor = '#F7F8FA'
      this.moveBlockBackgroundColor = '#008bf6'
      this.iconColor = '#000'
...
//
// .verify-left-bar {
//   background: #c8e6fd!important;
//   //border-color: $border-color!important;
//   border-color: #008bf6!important;
// }
</style>
